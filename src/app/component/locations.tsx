...
export default function locations() {
  return (
    ...
    <Container 
      ...
      <Heading fontSize={{base: '2xl', md: '4xl',}} color={useColorModeValue("ash.800", "ash.200")} mb='12'>ඔබ අවට ඇති විහාරස්ථාන.</Heading>
          <Box
          as="iframe"
          ...
          width={{base: "150px", md: "400px", lg: "800px",}}
          height={{base: "150px", md: "300px", lg: "600px",}}
          border="1px" 
          loading="lazy" 
          mx='auto'
          rounded="3xl"
